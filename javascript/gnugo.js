...
// Note: those function needs access to the module asm instantiate in the promise
function stackAlloc(l) {return Module['asm']["stackAlloc"](l);}
function stackRestore(s) {return Module['asm']["stackRestore"](s);}
function stackSave() {return Module['asm']["stackSave"]();}
function _memset(x, y, z) {return Module['asm']['_memset'](x, y, z);}
function _malloc(s) {return Module['asm']['_malloc'](s);}
function __get_timezone() {return Module['asm']['__get_timezone']();}
function __get_tzname() {return Module['asm']['__get_tzname']();}
function __get_daylight() {return Module['asm']['__get_daylight']();}
...
/*
** Here we comment the legacy createWasm, the loading is replace after using WebAssembly.instantiate
**
...
/* global initializers */  __ATINIT__.push({ func: function() { Module['asm']['___emscripten_environ_constructor']() } });
...
// HERE is the custom loading code
